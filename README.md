...
A dedicated web developer specializing in **backend** development with **2+ years** of professional experience in developing and improving **scalable** web solutions for SMEs. Currently seeking an opportunity to gain a deeper understanding of software engineering practices by working with a large team.

# 💼 Work Experiences

## ****Day Night Print / Backend Developer****

**2020 - PRESENT, Remote (UK)**
...
- Used technologies like **Laravel 8.61.0, MySQL,** and **Vue.js.** Utilized features like **Job Queuing** and **scheduling**; Integrated with other systems using **REST APIs**.

## ****Early Advantage / Software Engineer****

**2019 - 2020, Dhaka, Bangladesh**

- Created a FinTech MVP using **Laravel** that helped the startup attract foreign investment by providing financial solutions to SMEs.
- Invoice system, KYC verification, and payment gateways were implemented within **three months**, well ahead of the employer's five-month estimate.
...
- Provided assistance to faculty members in teaching courses such as **database management systems** and **object-oriented programming** by preparing lecture slides & questions for assignments and by invigilating exams.
- Provided after-class tutoring to average classes of 40 students.
